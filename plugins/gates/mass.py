    ...
    with open(file='plugins/usuarios/users.txt',mode='r+',encoding='utf-8') as archivo:
        ...
        if str(message.from_user.id) + '\n' in x:
            ...
            # REQUESTS INIT
                ...
                response = session.get('https://www.racquetballwarehouse.com/ccinfo.php')
                ...
                response = session.post(f'https://api.stripe.com/v1/setup_intents/pi_'+id+'/confirm',headers=headers,data=data,)
