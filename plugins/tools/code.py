    ...
    with open(file='plugins/usuarios/premium.txt',mode='r+',encoding='utf-8') as archivo:
        ...
        if str(message.from_user.id) + '\n' in x:
            ...
            await message.reply_photo(
                photo=carbon,
                caption="""<b>⎚ Create <b><a href="tg://resolve?domain=Sarcehkr">SarceDev[Owner]</a></b></b>""",
                reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("C R E A D O R", url="https://t.me/Sarcehkr")]]),                   
            )
            await m.delete()
            carbon.close()
        else:
