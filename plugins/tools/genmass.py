...
@Client.on_message(filters.command("genmass"))
async def genmass(client, message):
    with open(file='plugins/usuarios/users.txt',mode='r+',encoding='utf-8') as archivo:
        ...
        if str(message.from_user.id) + '\n' in x:
            ...
            if len(BIN) <6:
                return await message.reply("<b>⎚ Usar <code>/genmass 456789|rnd|rdn|rdn</code></b>")
            if not BIN:
                return await message.reply("<b>⎚ Usar <code>/genmass 456789|rnd|rdn|rdn</code></b>")
                apibincito = 6
...
━━━━━━━━━━━━━━━━━━━━━━
⎚ Create <b><a href="tg://resolve?domain=Sarcehkr">SarveDev[Owner]</a></b>
            </b>"""
